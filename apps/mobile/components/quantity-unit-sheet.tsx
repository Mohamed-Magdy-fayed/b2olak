...
export function QuantityUnitSheet({
  ...
  return (
    <AppBottomSheet
      visible={visible}
      onClose={onClose}
      title={itemDisplayName(item, locale)}
      subtitle={t("shop.pickerTitle")}
      footer={
        <>
          <Pressable
            ...
            className="min-h-14 flex-row items-center justify-center rounded-2xl bg-primary px-6 py-3 text-primary-foreground active:opacity-90"
          >
            {!selectedUnit ? (
