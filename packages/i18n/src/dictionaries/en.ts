...
const en = {
  ...
  shop: {
    ...
    pickerQuantity: "Quantity",
    pickerUnit: "Unit",
    pickerRecent: "Recently used",
    pickerCustom: "Custom amount",
    pickerUpdate: "Update cart",
    ...
    clearCartConfirmTitle: "Clear your cart?",
    clearCartConfirmMessage: "All items will be removed. This can't be undone.",
    cartTitle: "Your cart",
    ...
    reorderNoItems: "No available items to reorder.",
  ...
  admin: {
    ...
    pricing: {
      ...
      description:
        "Rebuild every item's average market price from real driver prices. New prices update automatically as orders are shopped — run this to backfill or fully recompute.",
      syncAll: "Sync all prices",
      running: "Syncing…",
      progress: "{processed} / {total} items",
      completed: "Synced {count} price groups",
      failed: "Sync failed",
    ...
    units: {
      ...
      nameAr: "Name (Arabic)",
      kind: "Kind",
      kindCount: "Count (pieces)",
      kindWeight: "Weight (kg, fractions)",
      kindMoney: "Money (EGP worth)",
      sortOrder: "Sort order",
      isActive: "Active",
